...
=================
   ...
   * [基本图形生成算法](#基本图形生成算法)
      * [直线段](#直线段)
         * [基础算法](#基础算法)
         * [数值微分算法(DDA)](#数值微分算法dda)
            * [如果不对k进行分类讨论](#如果不对k进行分类讨论)
         * [中点画线法](#中点画线法)
            * [在中点画线法中添加增量的思想](#在中点画线法中添加增量的思想)
         * [Bresenham画线法](#bresenham画线法)
            * [去点浮](#去点浮)
      * [圆弧](#圆弧)
         * [暴力算法](#暴力算法)
         * [中点画圆法](#中点画圆法)
            * [对增量本身再次使用增量思想](#对增量本身再次使用增量思想)
         * [Bresenham画圆法](#bresenham画圆法)
         * [正负法](#正负法)
         * [圆内接正多边形逼近法](#圆内接正多边形逼近法)
